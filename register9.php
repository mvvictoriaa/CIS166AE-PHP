...
mail($_POST['email'], 'Registration Confirmation', $body, 'From: mariavictoriatorreno@yahoo.com');
...
// Create the form:
?>
<form action="register9.php" method="post" class="form-inline">
